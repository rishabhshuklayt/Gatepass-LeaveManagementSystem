...
//     'b935ec9d3d6d5f76029a8e80ccdc7fa1',
//     '51e970a00a7f22adef65b2881eb379dd'
// );
...
mongoose.connect('mongodb+srv://rishabhshuklayt:BqoGZfNQjrwbLZGP@collegeprojects.hl9pzq6.mongodb.net/Registration?retryWrites=true&w=majority', {
...
app.post("/gateman_login", async(req,res)=>{
    ...
    try{
    const udata = await gatemanSchema.findOne({empid , password})
...
app.post('/acceptLeaveRequest', async (req, res) => {
    try {
      const requestId = req.body.requestId; // Get the request ID from the form data
